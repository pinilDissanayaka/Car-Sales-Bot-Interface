...
//                 <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white p-6 rounded-2xl shadow-xl mb-6">
...
//                 </p>
//                 <div className="bg-blue-900/30 border border-blue-800 p-3 sm:p-4 rounded-lg mb-6 max-w-sm">
//                   <div className="flex items-center gap-2 text-blue-300 text-sm sm:text-lg font-bold">
//                     📞 +81-45-402-6117
//                   </div>
...
//                   >
//                     <AlertCircle className="h-4 w-4 mb-1 text-green-400" />
...
//                   <div className="flex-shrink-0">
//                     <div className="w-8 h-8 bg-blue-600 border border-blue-500 rounded-full flex items-center justify-center text-white">
//                       <Bot className="h-4 w-4" />
//                     </div>
//                   </div>
...
//             <div className="relative flex items-end bg-gray-800 rounded-lg border border-gray-700 focus-within:border-gray-600 focus-within:bg-gray-800">
//               <textarea
//                 ref={textareaRef}
//                 value={inputValue}
...
//                 className="m-2 p-2 h-8 w-8 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-700 disabled:text-gray-500 rounded-md transition-colors"
//               >
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="py-8 space-y-6">
              ...
              {isTyping && (
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-10 h-10 bg-gradient-to-br from-red-600 to-red-800 border border-red-500 rounded-full flex items-center justify-center text-white">
